...
public class MultiActionText extends AbstractView<MultiActionText> implements MultiActionView<MultiActionText> {
    private TextView view;
    private SpannableString span;
    private String text;
    private boolean linksClickable, scrollable;
    private OnTextChangedListener<MultiActionText> listener;
    private OnPropertyChangedListener<MultiActionText> propertyChangedListener;
    ...
    @Override
    public void setOnTextChangedListener(final OnTextChangedListener<MultiActionText> listener) {
        OnTextChangedListener<MultiActionText> oldData = getOnTextChangedListener();
    ...
    @Override
    public void setOnPropertyChangedListener(OnPropertyChangedListener<MultiActionText> listener) {
        OnPropertyChangedListener<MultiActionText> oldData = getOnPropertyChangedListener();
    ...
    @Override
    public OnTextChangedListener<MultiActionText> getOnTextChangedListener() {
        return listener;
    }

    @Override
    public OnPropertyChangedListener<MultiActionText> getOnPropertyChangedListener() {
    ...
    public void addLinks(OnLinkClickListener<MultiActionText> link, CharSequence... subs) {
