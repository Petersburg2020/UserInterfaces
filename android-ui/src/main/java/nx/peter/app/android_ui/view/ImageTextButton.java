...
public class ImageTextButton extends AbstractView<ImageTextButton> implements MultiActionView<ImageTextButton> {
	...
	public void setForeground(@NonNull Foreground foreground) {
		switch (foreground) {
			...
			case Brown: setColor(Color.parseColor("#FF603608")); break;
			case Cyan: setColor(Color.CYAN); break;
			case Green: setColor(Color.GREEN); break;
			case Grey: setColor(Color.GRAY); break;
			case Lime: setColor(Color.parseColor("#FF84FF00")); break;
			case Pink: setColor(Color.parseColor("#FFFF00D8")); break;
			case Orange: setColor(Color.parseColor("#FFFF7500")); break;
			case Purple: setColor(Color.parseColor("#FF7500FF")); break;
