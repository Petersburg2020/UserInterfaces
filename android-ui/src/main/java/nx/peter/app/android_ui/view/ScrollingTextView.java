...
public class ScrollingTextView extends AbstractView<ScrollingTextView> implements MultiActionView<ScrollingTextView> {
    private TextView view;
    private SpannableString span;
    private String text;
    private boolean linksClickable, scrollable;
    private OnTextChangedListener<ScrollingTextView> listener;
    private OnPropertyChangedListener<ScrollingTextView> propertyChangedListener;
    ...
    @Override
    public void setOnTextChangedListener(final OnTextChangedListener<ScrollingTextView> listener) {
        OnTextChangedListener<ScrollingTextView> oldData = getOnTextChangedListener();
    ...
    @Override
    public void setOnPropertyChangedListener(OnPropertyChangedListener<ScrollingTextView> listener) {
        OnPropertyChangedListener<ScrollingTextView> oldData = getOnPropertyChangedListener();
    ...
    @Override
    public OnTextChangedListener<ScrollingTextView> getOnTextChangedListener() {
        return listener;
    }

    @Override
    public OnPropertyChangedListener<ScrollingTextView> getOnPropertyChangedListener() {
    ...
    public void addLinks(OnLinkClickListener<ScrollingTextView> link, CharSequence... subs) {
